...
namespace AdventOfCode2023.Tests
{
    public class Day16Tests
    {
        ...
        [InlineData(Day16.Tile.PrismUpDown, Day16.Dir.Up, new Day16.Dir[] { Day16.Dir.Up})]
        [InlineData(Day16.Tile.PrismUpDown, Day16.Dir.Down, new Day16.Dir[] { Day16.Dir.Down })]
        [InlineData(Day16.Tile.PrismUpDown, Day16.Dir.Left, new Day16.Dir[] { Day16.Dir.Up, Day16.Dir.Down })]
        [InlineData(Day16.Tile.PrismUpDown, Day16.Dir.Right, new Day16.Dir[] { Day16.Dir.Up, Day16.Dir.Down })]
        [InlineData(Day16.Tile.PrismLeftRight, Day16.Dir.Up, new Day16.Dir[] { Day16.Dir.Left, Day16.Dir.Right })]
        [InlineData(Day16.Tile.PrismLeftRight, Day16.Dir.Down, new Day16.Dir[] { Day16.Dir.Left, Day16.Dir.Right })]
        [InlineData(Day16.Tile.PrismLeftRight, Day16.Dir.Left, new Day16.Dir[] { Day16.Dir.Left })]
        [InlineData(Day16.Tile.PrismLeftRight, Day16.Dir.Right, new Day16.Dir[] { Day16.Dir.Right })]
        ...
        [Theory]
        [FileTestData("Day16/sample.in", 4)]
        [FileTestData("Day16/input.in", 41)]
