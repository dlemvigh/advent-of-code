...
public class Day1Tests {
    ...
    [Theory]
    [FileTestData("Day1/sample.in", 2020, 514579)]
    [FileTestData("Day1/input.in", 2020, 956091)]
    public void Part1(string input, int target, int expected) {
        Assert.Equal(expected, sut.Part1(input, target));
    }

    [Theory]
    [FileTestData("Day1/sample.in", 2020, 241861950)]
    [FileTestData("Day1/input.in", 2020, 79734368)]
