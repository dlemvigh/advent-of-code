...
public class Day17Tests {
    ...
    [Theory]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 0, 0, 0 }, false)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 1, 0, 0 }, true)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 2, 0, 0 }, false)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 0, 1, 0 }, false)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 1, 1, 0 }, false)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 2, 1, 0 }, true)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 0, 2, 0 }, true)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 1, 2, 0 }, true)]
    [FileTestData("Day17/sample.in", new [] { 3, 3, 1 }, new [] { 2, 2, 0 }, true)]
    ...
    [Theory]
    [FileTestData("Day17/sample.in", 112)]
    [FileTestData("Day17/input.in", 230)]
    public void Part1(string input, int expected) {
        Assert.Equal(expected, sut.Part1(input));
    }

    [Theory(Skip = "slow")]
    [FileTestData("Day17/sample.in", 848)]
    [FileTestData("Day17/input.in", 1600)]
